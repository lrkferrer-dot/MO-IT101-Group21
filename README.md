...
1. SSS: Uses a tiered bracket. For every ₱500 increment in Basic Salary, the contribution increases. It is capped at a maximum of ₱1,125 for salaries ₱24,750 and above.

2. PhilHealth: Calculated at 3% of the Monthly Basic Salary, then divided by 2 (Employee Share). It is capped at a maximum of ₱900.

3. Pag-IBIG: Calculated as 2% of the salary, but strictly capped at a maximum of ₱100 per month.

4. Withholding Tax: Calculated on Taxable Income (Basic Salary minus SSS, PhilHealth, and Pag-IBIG).
